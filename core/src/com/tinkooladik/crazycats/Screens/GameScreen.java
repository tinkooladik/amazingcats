...
class GameScreen extends ScreenAdapter {
	...
	GameScreen(AcidCat game) {
		...
		lifeLost = new TextureActor(new TextureRegion(AcidCat.manager.get(Assets.txrLostLife, Texture.class)));
		...
		dialog_bg = new TextureActor(new TextureRegion(AcidCat.manager.get(Assets.txrDialogBg, Texture.class)));
		dialog_btn = new TextureActor(new TextureRegion(AcidCat.manager.get(Assets.txrDialogBtn, Texture.class)));
