...
public class ChooseCats extends ScreenAdapter {
	...
	public ChooseCats (final AcidCat game) {
		...
		acidPrice.setPosition(width-width/5-50-acidPrice.getWidth(), height/4*3-140+(width/5-40)/2+20);
		...
		yourFishes.setPosition((width-yourFishes.getWidth())/2, height - yourFishes.getHeight()*3f);
